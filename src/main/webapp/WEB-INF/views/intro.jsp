...
<body>
	...
	<div id="body_div">
		...
		<div> <!-- 비누 제조 취지 -->
			...
			피부과 병원에 가서 약받아 발랐습니다. 그러다가 이듬해 3월경이 되서야 피부가 좀 
			괜찮아지곤 했습니다.
			</p>
			<p>그러던 중 2019년 봄 채석강 근처에서 한 과일 식초 비누를 접했습니다. 
			그리고 그해 가을 범이 다리 피부는 아무 일 없었습니다. 문제는 그 후, 
			그 비누 가격이 급등하여 가계에 부담이 된 것입니다. 급기야 범이는 유투브 동영상을
			보고 "올리브오일 엑스트라 버진" 수제비누를 만들어 사용하였고 품질은 
			만족스러웠습니다 -
			<a href="https://kin.naver.com/qna/detail.nhn?
			d1id=7&dirId=70111&docId=384413535&page=1#answer_2">
			관련 내용의 네이버 지식iN 답글</a>
			</p>
			<p>사실, 범이는 컴퓨터 프로그래머입니다. 그래서 범이는 2020년 후반기 
			한 공단에 전산 교사직 인턴으로 입사하는데, 비누 (잠재)고객에게는 다행으로, 
			정규직 채용에서 배제됩니다. 공단 퇴사 직후, 범이는 자기의 재능과 노력으로
			다음 두 부류의 사람들에게 기회를 드리자고 마음 먹었습니다 -  
			(먼저) 값은 싸지만 불량품인 비누로 인한 
			<span class="brown">피부 염증으로 고통</span>받고 계신 분, 
			(다음) <span class="brown">최저임금 일자리</span> 조차 못 구해서 
			생활고를 겪고 계신 분.
			</p>
			<p>그래서 범이는 2020년 12월 24일 밤부터 범이비누 제조를 시작하였습니다.
			</p>
		</div>
	</div>
</body>
